...
class DatabaseHandler(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private lateinit var CREATE_HAPPY_PLACE_TABLE : String
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        CREATE_HAPPY_PLACE_TABLE = ("CREATE TABLE " + TABLE_HAPPY_PLACE + "("
    ...
    //Creating a function to delete the existing happy place detail.)
    /**
