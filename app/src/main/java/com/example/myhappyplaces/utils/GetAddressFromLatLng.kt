...
private const val TAG = "GetAddressFromLatLngDebug"

//AsyncTask class fot getting an address from the latitude and longitude from the location provider.)
// START
/**
    ...
    override fun doInBackground(vararg params: Void?): String {
        try {
            ...
            if (addressList != null && addressList.isNotEmpty()) {
                ...
                Log.d(TAG, "Address to string : $sb")

                return sb.toString()
            }
        } catch (e: Exception) {
            Log.d(TAG, "Unable connect to Geocoder")
        }
        return ""
    }
